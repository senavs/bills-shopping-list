  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        {item.includeInTax && <span title="Taxed" className="text-sm mr-1">🧾</span>}
        <button
          onClick={onEdit}
          className="w-9 h-9 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
